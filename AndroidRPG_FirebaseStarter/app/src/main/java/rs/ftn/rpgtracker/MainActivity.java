...
public class MainActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState){
    ...
    if(Prefs.getUid(this)==null || FirebaseAuth.getInstance().getCurrentUser()==null){ startActivity(new Intent(this, LoginActivity.class)); finish(); return; }
    btnProfile=findViewById(R.id.btnProfile); btnShop=findViewById(R.id.btnShop); btnFriends=findViewById(R.id.btnFriends); btnChat=findViewById(R.id.btnChat); btnLogout=findViewById(R.id.btnLogout);
